...
Remove-Module DuckDB.Client -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\DuckDB.Client\DuckDB.Client.psd1"
Import-Module "$PSScriptRoot\..\DuckDB.Client\DuckDB.Client.psm1" -Force
