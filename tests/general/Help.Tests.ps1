...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\DuckDB.Client\functions", "$global:testroot\..\DuckDB.Client\internal\functions"),
	
	[string]
	$ModuleName = "DuckDB.Client",
...
$CommandPath = @(
    "$global:testroot\..\DuckDB.Client\functions"
    "$global:testroot\..\DuckDB.Client\internal\functions"
)
